...
def submit_feedback(complaint_id):
    ...
    if complaint.status not in [Complaint.STATUS_RESOLVED, Complaint.STATUS_CLOSED]:
        flash("Feedback can only be submitted for resolved or closed complaints.", "warning")
